...
namespace custom_copy_backend.Component.DCInside
{
    public class DCInsideUtils
    {
        ...
        {
            return JsonConvert.DeserializeObject<SortedDictionary<string, string>>(NetTools.DownloadString("https://raw.githubusercontent.com/dc-custom/custom-copy-windows/master/dcinside-minor-gallery.json"));
        }

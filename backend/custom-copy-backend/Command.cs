...
namespace custom_copy_backend
{
    public class Options : IConsoleOption
    {
        ...
        [CommandLine("--starts-with-client", CommandType.OPTION, Default = true,
            Info = "Starts Custom Copy server with client.", Help = "use --starts-with-client")]
    ...
    public class Command
    {
        ...
        static void PrintHelp()
        {
            ...
            Console.WriteLine($"");
            Console.WriteLine("Usage: ./custom-copy-backend [OPTIONS...]");
